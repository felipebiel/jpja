        ...
        <div class="col-md-10 col-md-offset-1">
            <div class="panel panel-default">
                ...
                @include('sistema.partes.mensagens')
                       ...
                       {!! Form::model($tema, ['route' => ['sistema.temas.atualizar', $tema->id], 'method' =>'PUT','enctype' =>'multipart/form-data', 'class' => 'form-horizontal', 'id'=>'formTemasEditar' ]) !!}
...
$(document).ready(function(){
  ...
  /*imagem no editar*/
$('[name="input_imagem_tema"]').val('{{$tema->imagem}}'); 
$("#imageTema").css("background-image", "url('{{ url('arquivos/img_temas').'/'.$tema->imagem}}')");
...
$(document).on('click', '#sendTema', function() {
    ...
    $.ajax({
        type:'post',
        url: '{{ url('sistema/temas/atualizar')}}/'+{{$tema->id}},
        dataType: 'json',
        data: $('#formTemasEditar').serialize(),
    })
    .done(function(data, textStatus, jqXHR){
        $('#formTemasEditar').submit();
    })
    .fail( function(jqXHR){
